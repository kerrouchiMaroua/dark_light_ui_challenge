...
class AppThemes {
  ...
  static String getImage(BuildContext context) {
    if (Theme.of(context).brightness == Brightness.dark) {
      return '/Users/kerrouchiimad/flutter_application_1/assets/images/darkmode.png';
    } else {
      return '/Users/kerrouchiimad/flutter_application_1/assets/images/lightmode.png';
    }
  }
}